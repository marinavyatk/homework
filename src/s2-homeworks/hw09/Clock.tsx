...
function Clock() {
    ...
    const start = () => {
        ...
        const intervalId = setInterval(()=>{setDate(new Date(restoreState('hw9-date', Date.now())))}, 1000)
    ...
    const stringMonth = date.toLocaleDateString('en-US', {weekday: 'long'}) || <br/> // пишут студенты
